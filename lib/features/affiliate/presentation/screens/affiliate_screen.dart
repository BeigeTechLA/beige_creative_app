...
class _AffiliateScreenState extends ConsumerState<AffiliateScreen> {
  ...
  Widget _buildBody(BuildContext context, AffiliateState state) {
    final summary = state.summary;

    return RefreshIndicator(
      color: AppColors.primary,
      backgroundColor: AppColors.surface,
      onRefresh: () => ref.read(affiliateNotifierProvider.notifier).refresh(),
        ...
        child: Column(
          ...
          children: [
            ...
            const Padding(
              ...
              child: HomeSectionDivider(centerAlpha: 0.24),
            ),
            const SizedBox(height: AppSpacing.sectionGap),
            Padding(
