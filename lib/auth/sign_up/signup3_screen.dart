                                                    ...
                                                    children: [
                                                      ...
                                                      _featuredSheet();
                                                              ...
                                                              child: Container(
                                                                ...
                                                                decoration: BoxDecoration(
                                                                  color: ColorCode.black.withOpacity(0.8),
                                                                  shape: BoxShape.circle,
                                                                ),
                                                                child: const Icon(
                                                                  Icons.edit,
                                                            ...
                                                            GestureDetector(
                                                              ...
                                                              child: Container(
                                                                ...
                                                                width: 30,
                                                                decoration: BoxDecoration(
                                                                  color: ColorCode.red.withOpacity(0.8),
                                                                  shape: BoxShape.circle,
                                                                ),
                                                                child: const Icon(
                                                                  Icons.delete,
                                                ...
                                                return Container(
                                                  ...
                                                  child: Row(
                                                    children: [
                                                      ...
                                                      /// FILE ICON
                                                      const Icon(Icons.link, color: ColorCode.white),
                                                      ...
                                                      /// VIEW
                                                      IconButton(
                                                        icon: const Icon(Icons.remove_red_eye, color: ColorCode.white),
                                                        onPressed: () {
                      ...
                      child: DottedBorder(
                        ...
                        //    color: const Color(0xFF1E1E1E),
                          ...
                          child: tempFeaturedImages.isEmpty
                            ...
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: const [
                              Icon(Icons.upload, color: ColorCode.white, size: 28),
                              SizedBox(height: 10),
                              Text(
                      ...
                      child: Builder(
                        builder: (context) {
                          ...
                          return ElevatedButton(
                            style: ElevatedButton.styleFrom(
                              backgroundColor:
                              isValid ? ColorCode.kButtonColor : ColorCode.grey,
                              shape: RoundedRectangleBorder(
                                borderRadius: BorderRadius.circular(14),
                              ),
                            ),
