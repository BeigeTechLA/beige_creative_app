...
class ChangePassThrowProfile extends StatefulWidget {
  final String? email;
  final String? otp;

  const ChangePassThrowProfile({
    super.key,
     this.email,
     this.otp,
  });
  ...
  @override
  State<ChangePassThrowProfile> createState() =>
      _ChangePassThrowProfileState();
}

class _ChangePassThrowProfileState
    extends State<ChangePassThrowProfile> {
